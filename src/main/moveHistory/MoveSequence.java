...
public class MoveSequence {
	 ...
	 */
	MovePattern movePerformed;
	
	private void init(ChessPiece performingPiece, MovePattern performingMove, ChessSpace target, List<ChessSpace> liftPlaceSequence) {
		targetSpace= target;
	 ...
	 */
	public MoveSequence(ChessBoard board, JSONObject commandObject) throws JSONException, ClassNotFoundException {
		...
		for(MovePattern move : performingPiece.getMoves())
	 ...
	 */
	public MoveSequence(ChessPiece performingPiece, MovePattern performingMove, ChessSpace target, List<ChessSpace> liftPlaceSequence) {
	...
	public MovePattern getMovePerformed(){
