...
public abstract class ChessMove {	
	 ...
	 */
	protected List< CommandSequence> commandSequences;
	 ...
	 * @param owner of move
	 */
	public ChessMove(ChessPiece owner){
		this.owner= owner;
		commandSequences = new ArrayList< CommandSequence>();
		dependentSpaces= new Stack<ChessSpace>();
		if(owner != null)
			owner.addMoves(this);
	}
	
	public abstract ChessMove copy(ChessPiece owner);
	...
	protected final void addCommandSequence(ChessSpace target, ChessSpace...liftPlaceSequence){
		commandSequences.add( new CommandSequence(owner, this, target, liftPlaceSequence));
	}
